...
weekends: "6:00 AM - 11:00 AM",
  ...
  gajulramaram: {
    ...
    trainers: [
      ...
      {
        name: "KILBORTSON SILAS PARICHHA",
        specialization: "Personal training and body transformation",
        experience: "11 years",
