...
const locationData: LocationData = {
  ...
  "ashok-nagar-bhel": {
    ...
    description: "STALLION gym with CULT Partnership offering premium amenities and specialized programs. As a CULT-affiliated center, members enjoy access to exclusive group fitness classes, yoga studios, and dedicated wellness zones along with traditional STALLION strength training.",
    ...
    trainers: [
      {
        ...
        certifications: ["Corporate Wellness Specialist", "Posture Restoration"]
      },
      {
        name: "Kavya Rao",
...
export default function BranchLocation() {
  ...
  useEffect(() => {
    if (params?.locationId) {
      ...
      const foundLocation = locationData[locationKey as keyof typeof locationData];
      if (foundLocation) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4 text-black">Location not found</h2>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-black font-medium">{location.address}</span>
                </div>
                <div className="flex items-center">
                  <Phone className="h-5 w-5 text-[#e71b4b] mr-3" />
                  <span className="text-black font-medium">{location.phone}</span>
                </div>
                <div className="flex items-center">
                  <Mail className="h-5 w-5 text-[#e71b4b] mr-3" />
                  <span className="text-black font-medium">{location.email}</span>
                </div>
                <div className="flex items-center">
  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2">
        ...
        {selectedVideo && (
          <h4 className="text-xl font-semibold mt-4 text-white">{selectedVideo.title}</h4>
        )}
      </div>

      {/* Video Playlist */}
      <div className="space-y-4">
        <h4 className="text-lg font-semibold mb-4 text-white">More Videos</h4>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {location.trainers.map((trainer: Trainer, index: Key | null | undefined) => (
              <div key={index} className="bg-gray-50 rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold mb-1 text-black">{trainer.name}</h4>
                  <p className="text-[#e71b4b] font-medium mb-2">{trainer.specialization}</p>
