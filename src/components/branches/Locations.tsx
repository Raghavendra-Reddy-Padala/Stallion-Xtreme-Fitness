...
export default function Locations() {
  ...
  const openMap = (
    mapUrl: React.SetStateAction<string>,
    locationName: React.SetStateAction<string>
  ) => {
                      ...
                      <div className="flex flex-col space-y-3">
                        <div className="space-y-1 mb-2">
                          <div className="text-sm sm:text-base text-gray-100">
                            <span className="inline-block w-full text-ellipsis overflow-hidden">
                              {location.address}
                            </span>
                          </div>
                          <div className="text-sm sm:text-base text-gray-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                          ...
                          >
                            <button
                              onClick={() =>
                                openMap(location.mapUrl, location.name)
                              }
